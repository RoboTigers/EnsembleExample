...
@objc public protocol GTNotificationViewDelegate: NSObjectProtocol
{
    ...
    */
    @objc optional func notificationViewTapped(_ notificationView: GTNotificationView)
}
...
*/
open class GTNotificationView: UIView
{
    // MARK: - Constants
    ...
    open weak var delegate: GTNotificationViewDelegate?
...
//            toItem: self.titleLabel!,
//            attribute: NSLayoutAttribute.Left,
            toItem: self.imageView!.image != nil ? self.imageView! : self,
            attribute: self.imageView!.image != nil ? NSLayoutAttribute.right : NSLayoutAttribute.left,
            multiplier: 1.0,
//            constant: 0.0
            constant: 10.0
        ))
...
//            constant: -self.verticalPadding
    ...
    */
    func heightForNoticationView() -> CGFloat {
        ...
        let maximumLabelSize: CGSize = CGSize(width: maximumLabelWidth, height: CGFloat.greatestFiniteMagnitude)
    ...
    */
    func prepareForNotification(_ notification: GTNotification)
    {
    ...
    */
    @objc fileprivate func notificationTapped()
    {
        // Notify the delegate that the notification view was tapped
        if (self.delegate?.responds(to: #selector(GTNotificationViewDelegate.notificationViewTapped(_:))) == true)
        {
...
open class GTNotificationManager: NSObject, GTNotificationViewDelegate
{
    // MARK: - Variables
    
    /// The singleton instance of the GTNotificationManager
    open static var sharedInstance: GTNotificationManager = GTNotificationManager()
    
    /// The private array of notifications queued for display
    fileprivate var mutableNotifications: [GTNotification] = []
    
    /// The current notification view being displayed
    fileprivate var currentNotificationView: GTNotificationView?
    ...
    */
    open func showNotification(_ notification: GTNotification)
    {
    ...
    */
    @objc fileprivate func dismissCurrentNotification(_ timer: Timer?)
    {
    ...
    */
    open func dismissCurrentNotification() {
        if let notificationView = self.currentNotificationView {
            // Animate the notification
    ...
    @objc open func notificationViewTapped(_ notificationView: GTNotificationView)
    {
